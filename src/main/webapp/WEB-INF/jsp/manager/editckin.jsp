...
<%@include file="common/head.jsp"%>
	...
	<form class="form-horizontal form-label-left" method="post" action="update" onsubmit="return checkall()">
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-5">
                            <input id="price" name="price" class="form-control col-md-7 col-xs-5" value="${ckin.price}"  type="text" onblur="checkprice()"><span id="demo5" style="color: red;"></span>
                        </div>
                    </div>
                     <div class="item form-group">

...
<%@include file="common/head.jsp"%>
	...
	<form class="form-horizontal form-label-left" method="post" action="insert" onsubmit="return checkall()">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="item form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-5" >单价 <span >*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-5">
                                <input id="price" name="num" class="form-control col-md-7 col-xs-5" value="${ckin.price}"  type="text" onblur="checkprice()"><span id="demo5" style="color: red;"></span>
                            </div>
                        </div>
                     <div class="item form-group">
...
function checkprice()
{
    ...
    if( price )
    {
        if( !isNaN( price ) )
        {
            ...
            document.getElementById("demo5").innerHTML="请输入正确的商品价格！";
...
/*function checksumprice()
{
    var sumprice = document.getElementById('sumprice').value;
    if( sumprice )
    {
        if( !parseFloat( sumprice ) )
        {
            document.getElementById("demo6").innerHTML=" ";
            return true;
        }else{
            document.getElementById("demo5").innerHTML="请输入正确的商品总价！";
            document.getElementById('sumprice').value="";
            document.getElementById('sumprice').focus();
            return false;
        }
    }
    else{
